...
IpkissWithCommon is available through [CocoaPods](http://cocoapods.org). To install
it, simply add the following line to your Podfile:

```ruby
pod "IpkissWithCommon"
```

## Author

ChristingLi, 969420780@qq.com

## License

IpkissWithCommon is available under the MIT license. See the LICENSE file for more info.
