#
#  Be sure to run `pod spec lint IpkissWhitCommon.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/ChristingLi/IpkissWithCommon"
  ...
  spec.author             = { "IpKiss" => "anersonld@gmail.com" }
  # Or just: spec.author    = "li"
  # spec.authors            = { "li" => "anersonld@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/li"
  ...
  # 
  spec.frameworks   = "UIKit", "Foundation","Photos" #支持的框架
